...
class AirQualityService:
    ...
    @classmethod
    def get_air_quality(cls, latitude, longitude):
        try:
            ...
            return {
                "current": cls._current_air_quality(times, values),
                "forecast": cls._daily_forecast(times, values),
            }
    ...
    @classmethod
    def _current_air_quality(cls, times, values):
    ...
    @classmethod
    def _daily_forecast(cls, times, values):
