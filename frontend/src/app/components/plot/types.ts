...
export type PlotState = "available" | "active" | "help-needed" | "pending" | "mine";

export const plotColors: Record<PlotState, { bg: string; border: string; text: string; label: string }> = {
